...
Real-time proctoring safeguards help maintain meeting integrity:

- Automatic detection of multiple faces in the camera frame
- Alerts when the participant's face leaves or drifts to the edge of the frame
- In-call warnings through visual banners and toasts for quick intervention
- TensorFlow-powered fallback keeps detection working even on browsers without the native Face Detector API
- Graceful messaging when detection libraries cannot be initialized
## Exit Meeting
...
## Team Members
1. Shaurya Nitin - 1AY22IS097
2. Shubham Srivastava - 1AY22IS102
3. Ujjawal Gautam - 1AY22IS120
4. Vedant Shravan - 1AY22IS123
...
=======
# callify-meet
Callify is a real-time video conferencing application built with Next.js, Tailwind CSS, Clerk, and GetStream. It provides secure meetings with features like scheduling, screen sharing, participant controls, face-detection based malpractice monitoring, personal meeting rooms, and meeting recordings. 
>>>>>>> a784c638781a0bd337af7d0411253ab052ad5362
